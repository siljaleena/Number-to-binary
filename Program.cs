namespace Number_to_binary
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //keeps the user in the program until they choose to exit it, so you can do multiple conversions
            do
            {
                ...
                //runs the program until the boolean 'isValidInput' becomes true
            } while (!isValidInput);
